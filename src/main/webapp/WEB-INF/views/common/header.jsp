...
<head>
	...
	<!-- Libs CSS -->
	<link rel="stylesheet" type="text/css" href="${path}/resources/fonts/feather/feather.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/bootstrap-icons/font/bootstrap-icons.css" />
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/dragula/dist/dragula.min.css" />
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/@mdi/font/css/materialdesignicons.min.css" />
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/dropzone/dist/dropzone.css" />
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/magnific-popup/dist/magnific-popup.css" />
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/bootstrap-select/dist/css/bootstrap-select.min.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/@yaireo/tagify/dist/tagify.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/tiny-slider/dist/tiny-slider.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/tippy.js/dist/tippy.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/prismjs/themes/prism-okaidia.min.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/simplebar/dist/simplebar.min.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/nouislider/dist/nouislider.min.css">
	<link rel="stylesheet" type="text/css" href="${path}/resources/libs/glightbox/dist/css/glightbox.min.css">
	...
	<title>${param.title}</title> <%-- content가 있는 jsp파일에서 include할 때 결정됨, home.jsp참고 --%>
	
	<!-- 우리가 추가한 style -->
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR&display=swap" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="${path}/resources/css/mymain.css">
	<script src="https://kit.fontawesome.com/1fa5c8fe86.js" crossorigin="anonymous"></script>
</head>
...
<nav class="navbar navbar-expand-lg navbar-default header">
	<div class="container-fluid px-0">
		<a class="navbar-brand" href="${path}">
			<img src="${path}/resources/images/ours/logo_header.png" />
		</a>
...
<!-- 프로필 시작 -->
	<%-- 로그아웃 상태 --%>
	<c:if test="${loginMember == null}"> <!-- 로그인 기능 될 때 == 로 수정 -->
				<a class="rounded-circle ms-auto d-none d-lg-block" href="${path}/member/login">
					<div class="avatar avatar-md">
						<img
							alt="avatar"
							src="${path}/resources/images/ours/logout.png"
							...
							<ul class="list-unstyled">
								<li>
									<a class="dropdown-item" href="${path}/logout">
										<i class="fe fe-power me-2"></i>로그아웃
									</a>
								</li>
							</ul>
						</div>
