...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="./resources/images/ours/ours/favicon.ico">
	...
	<link id="style-switch" rel="stylesheet" type="text/css" href="./resources/css/display.css">
...
<section  class="pt-3 pb-3 mb-2 card-grid second content" >
<div  class=" center frist" >
<h3>상세 검색</h3>
<form id="" name="displaySearch" action="#" method="post">
<table class="table" >
  <tr>
  <th noWrap><input class="searchSize" type="search" class="center" placeholder="지역을 입력해주세요"></th>
  <th noWrap></th>
  <th noWrap><input type="date" class="calender" name="trip-start" value="2022-12-25" 
			...
			<div class="col-12">
				<div class="tiny-slider arrow-hover arrow-blur arrow-white arrow-round rounded-3 overflow-hidden">
					...
					data-items="1">
						...
						<!-- Slide 1 -->
						<div class="card bg-dark-overlay-3 h-400 h-sm-500 h-md-600 rounded-0" style="background-image:url(./resources/images/ours/display_img.jpg); background-position: center left; background-size: cover;">
							<!-- Card Image overlay -->
		          <div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
		            <div class="w-100 my-auto">
			            <div class="col-md-10 col-lg-7 mx-auto text-center">
			            	<!-- Card category -->
			            	<!-- Card title -->
			              <h2 class="text-white display-5"><a href="post-single-2.html" class="btn-link text-reset fw-normal"></a></h2>
...
<section class="pt-4 pb-0 card-grid">
	<div class="container">
		<div class="row g-4">
			<!-- Left big card -->
			<div class="col-lg-6">
				<div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url(http://tkfile.yes24.com/Upload2/Display/202210/20221024/gmain_top_43842.jpg/dims/quality/70/);background-position: center left; background-size: cover; ">
					<!-- Card featured -->
					...
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
						<div class="w-100 mt-auto">
							...
							<!-- Card title -->
							<h2 class="text-white h1"><a href="#" class="btn-link stretched-link text-reset">함부르크 걸작들</a></h2>
			...
			<div class="col-lg-6">
				<div class="row g-4">
					<!-- Card item START -->
					<div class="col-12">
						<div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(http://tkfile.yes24.com/Upload2/Display/202211/20221121/gmain_top_43955.jpg/dims/quality/70/); background-position: center left; background-size: cover;">
							<!-- Card Image -->
							<!-- Card Image overlay -->
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
								<div class="w-100 mt-auto">
									...
									<!-- Card title -->
									<h4 class="text-white"><a href="post-single-4.html" class="btn-link stretched-link text-reset">외규장각 전시회</a></h4>
					...
					<!-- Card item START -->
					<div class="col-md-6">
						<div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(http://tkfile.yes24.com/Upload2/Display/202209/20220919/gmain_top_haribo.jpg/dims/quality/70/); background-position: center left; background-size: cover;">
							<!-- Card Image overlay -->
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
								<div class="w-100 mt-auto">
									<!-- Card category -->
									...
									<!-- Card title -->
									<h4 class="text-white"><a href="post-single-4.html" class="btn-link stretched-link text-reset">곰돌이 생일</a></h4>
									<!-- Card info -->
					...
					<!-- Card item START -->
					<div class="col-md-6">
						<div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url(http://tkfile.yes24.com/Upload2/Display/202209/20220901/gmain_top_43301.jpg/dims/quality/70/); background-position: center left; background-size: cover;">
							<!-- Card Image overlay -->
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
								<div class="w-100 mt-auto">
									<!-- Card category -->
									...
									<!-- Card title -->
									<h4 class="text-white"><a href="post-single-4.html" class="btn-link stretched-link text-reset">뒤뷔페</a></h4>
                ...
                <div class="sliderFirst">
                    <div class="item">
                        ...
                        <div class="card  mb-4 card-hover">
                            <a href="pages/course-single.html" class="card-img-top"><img src="http://tkfile.yes24.com/upload2/perfblog/202210/20221028/20221028-42880.jpg/dims/quality/70/" alt="" class="rounded-top-md card-img-top"></a>
                            <!-- Card Body -->
                            <div class="card-body">
                                <h5 class="mb-2 text-truncate-line-2 "><a href="pages/course-single.html" class="text-inherit">다이노스 제주</a></h5>
                                <!-- List -->
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="card-footer">
                                <div class="row align-items-center g-0">
                                    <div class="col-auto">
                                        <img src="resources/images/ours/avatar/avatar-1.jpg" class="rounded-circle avatar-xs" alt="">
                                    </div>
                                    <div class="col ms-2">
                    ...
                    <div class="item">
                        <!-- Card -->
                        <div class="card  mb-4 card-hover">
                            <a href="pages/course-single.html" class="card-img-top"><img src="http://tkfile.yes24.com/upload2/perfblog/202209/20220922/20220922-43614.jpg/dims/quality/70/" alt="" class="card-img-top rounded-top-md"></a>
                            <!-- Card Body -->
                            <div class="card-body">
                                <h5 class="mb-2 text-truncate-line-2 "><a href="pages/course-single.html" class="text-inherit">프랑코 폰타나</a></h5>
                                <!-- List -->
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="card-footer">
                                <div class="row align-items-center g-0">
                                    <div class="col-auto">
                                        <img src="resources/images/ours/avatar/avatar-3.jpg" class="rounded-circle avatar-xs" alt="">
                                    </div>
                                    <div class="col ms-2">
                    ...
                    <div class="item">
                        <!-- Card -->
                        <div class="card  mb-4 card-hover">
                            <a href="pages/course-single.html" class="card-img-top"><img src="http://tkfile.yes24.com/upload2/perfblog/202211/20221128/20221128-40444.jpg/dims/quality/70/" alt="" class="card-img-top rounded-top-md"></a>
                            <!-- Card Body -->
                            <div class="card-body">
                                <h5 class="mb-2 text-truncate-line-2 "><a href="pages/course-single.html" class="text-inherit">강원 세계 젬버린</a></h5>
                                <!-- List -->
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="card-footer">
                                <div class="row align-items-center g-0">
                                    <div class="col-auto">
                                        <img src="resources/images/ours/avatar/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                    </div>
                                    <div class="col ms-2">
                    ...
                    <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="card-footer">
                                <div class="row align-items-center g-0">
                                    <div class="col-auto">
                                        <img src="resources/images/ours/avatar/avatar-2.jpg" class="rounded-circle avatar-xs" alt="">
                                    </div>
                                    <div class="col ms-2">
